...
const meta = {
  ...
  argTypes: {
    currentPath: {
      ...
      control: {
        type: "select",
        options: ["/", "/kindergarten", "/community", "/bookmarks", "/user"],
      },
    },
  },
      ...
      <div className="space-y-4">
        <SpecGrid>
          ...
          <SpecTable
            ...
            data={[
              ["홈", "/", "home", "홈"],
              ["유치원", "/kindergarten", "kindergarten", "유치원"],
    ...
    <main className="flex flex-col gap-6">
      <Section title="Navigation States">
        <div className="space-y-4">
          ...
          <div>
            <h4 className="mb-2 text-sm font-medium">Kindergarten Active</h4>
            <div className="relative h-24 rounded-lg border bg-gray-50">
              <div className="absolute bottom-0 w-full">
                <GlobalNavBar currentPath="/kindergarten" />
              </div>
            </div>
          </div>
