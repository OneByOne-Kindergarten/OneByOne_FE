...
import Metadata from "@/common/hooks/useMetadata";
import Main from "@/common/ui/layout/main";
import Wrapper from "@/common/ui/layout/page-wrapper";
import BaseHeader from "@/widgets/headers/base-header";
import BookmarkHeader from "@/widgets/headers/bookmark-header";
import CommunityHeader from "@/widgets/headers/community-header";
import KindergartenHeader from "@/widgets/headers/kindergarten-header";
import SaveHeader from "@/widgets/headers/save-header";
import GlobalNavBar from "@/widgets/nav/global-nav-bar";
