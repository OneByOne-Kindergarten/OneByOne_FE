...
const inputVariants = cva(
  "flex max-h-11 w-full rounded-lg transition-colors disabled:cursor-not-allowed disabled:opacity-50 border border-transparent focus-visible:outline-none",
  {
    variants: {
      variant: {
        default:
