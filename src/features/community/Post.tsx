...
import { CATEGORY_LABELS } from "@/common/constants/community";
import { URL_PATHS } from "@/common/constants/url-path";
import AlertCard from "@/common/ui/alert/alert-card";
...
import ChatCount from "@/features/community/ChatCount";
